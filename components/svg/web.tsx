...
export const Web: React.FC<ISvgProps> = ({ height, width }) => {
     return (
          <svg width={width} height={height} viewBox="0 0 1139.17088 654.54324">
